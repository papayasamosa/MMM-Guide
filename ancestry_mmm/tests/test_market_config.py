...
class TestMarketDescriptors:
    ...
    def test_round_trip(self):
        d = MarketDescriptors(
            population=67_000_000, market_maturity="Mature", region="Europe"
        )
...
class TestMarketCurrency:
    def test_round_trip(self):
        c = MarketCurrency(
            ...
            exchange_rate_to_reporting=1.27,
        )
