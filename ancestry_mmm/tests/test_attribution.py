...
class TestTotalFhContributionSegmentsFilter:
    ...
    def test_outcome_ids_filter_excludes_dna_kit_outcome_from_the_total(self, frame, meta, params):
        ...
        total_fh_only = total_fh_contribution(frame, meta, params, contributions, ltv=None, outcome_ids=fh_only_outcome_ids)
        total_all = total_fh_contribution(frame, meta, params, contributions, ltv=None, outcome_ids=None)
    ...
    def test_outcome_ids_filter_matches_manual_sum_over_the_kept_outcome_ids(self, frame, meta, params):
        contributions = compute_shapley_contributions(frame, meta, params, n_permutations=20)
