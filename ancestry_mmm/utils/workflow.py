...
WORKFLOW_STEPS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "steps": [
            ...
            "Continue to Data Coverage.",
        ],
        "next": "Review variable coverage and missingness in Data Coverage.",
    },
    {
        "key": "data_coverage",
        "label": "Data Coverage",
        ...
        "title": "Data Coverage",
        "purpose": "Review each variable's coverage and missingness by market before defining model structure (REQ-COVERAGE-001) - optional, but every candidate model must expose a coverage matrix before fitting.",
        "steps": [
