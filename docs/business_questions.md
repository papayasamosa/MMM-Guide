...
| Question | Status |
|---|---|
| What is the incremental contribution of each channel, in total? | **Answered today** - Results & Response Curves page, shared curve across markets. |
...
| How many impressions, GRPs, or TVRs are required for a target response? | **Not yet** - requires the response-unit curve (Phase 3); Phase 1 adds the data capture (Activity Mapping page) this depends on. |
